	...
	return (
		<Container>
			<Grid
				...
				<Grid item className={styles.spacedApart}>
				...
				<Grid item className={styles.spacedApart}>
					...
					<Typography variant="body1" gutterBottom>
						...
						may not overlap each other. No ships may be placed on another ship. Once the guessing begins, the players
						may not move the ships. The 5 ships are: Carrier (occupies 5 spaces), Battleship (4), Cruiser (3), Submarine
						(3), and Destroyer (2).
					</Typography>
				</Grid>
				<Grid item className={styles.spacedApart}>
					...
					<Typography variant="body1" gutterBottom>
						...
						will be sunk. You should announce "hit and sunk". In the physical game, a red peg is placed on the top edge
						of the vertical board to indicate a sunk ship. As soon as all of one player's ships have been sunk, the game
						ends.
					</Typography>
				</Grid>
			</Grid>
